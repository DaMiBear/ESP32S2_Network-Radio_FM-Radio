...
esp_err_t scr_interface_create(scr_interface_type_t type, void *config, scr_interface_driver_t **out_driver)
{
    ...
    case SCREEN_IFACE_SPI: {
        ...
        // printf("size of interface_spi_handle_t %d\n", sizeof(interface_spi_handle_t));
        // interface_spi_handle_t *interface_spi = heap_caps_malloc(sizeof(interface_spi_handle_t), MALLOC_CAP_8BIT);
        // interface_spi_handle_t *interface_spi = NULL;
